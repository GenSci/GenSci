"""
Django settings for gensci project.
...
SECRET_KEY = '5wyy8g*)wh+5%phzrwg!soqy%*eh+c@a*$#l^rp=7hn0@2elr_'
...
WSGI_APPLICATION = 'gensci.wsgi.application'
